...
<head>
    ...
    <style type="text/css">
        @import url(https://fonts.googleapis.com/css?family=Arvo:400,400italic,700,700italic|Crete+Round:400,400italic|Raleway:400,700,400italic);

    </style>
    <link
        href="https://fonts.googleapis.com/css?family=Arvo:400,400italic,700,700italic|Crete+Round:400,400italic|Raleway:400,700,400italic"
        rel="stylesheet" type="text/css" />

    <table class="wrapper"
        style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #001a1d;"
        ...
        <tbody>
            <tr>
                <td>
                    <div>
                        <div
                            style="background-color: #a73407;background: 0% 0%/cover no-repeat url(https://i1.createsend1.com/ei/t/D6/505/CF4/220249/csfinal/images.jpeg) #a73407;background-position: 0% 0%;background-image: url(https://i1.createsend1.com/ei/t/D6/505/CF4/220249/csfinal/images.jpeg);background-repeat: no-repeat;background-size: cover;">
                            <div class="layout one-col stack"
                                ...
                                <div class="layout__inner"
                                    ...
                                    <div class="column"
                                        style="text-align: left;color: #001a1d;font-size: 17px;line-height: 26px;font-family: Raleway,Trebuchet MS,Avenir,Segoe UI,sans-serif;">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="column"
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div
                                            ...
                                            <blockquote
                                                style="Margin-top: 20px;Margin-bottom: 0;Margin-left: 0;Margin-right: 0;padding-left: 14px;border-left: 4px solid #000;">
                                                <p style="Margin-top: 20px;Margin-bottom: 0;">Judul Pengaduan :
                                                    <strong>{{$data->judul_laporan}}</strong></p>
                                                <p style="Margin-top: 20px;Margin-bottom: 0;">Nama
                                                    Pelapor&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :
                                                    <strong>{{$data->nama}}</strong>
                                                </p>
                                                <p style="Margin-top: 20px;Margin-bottom:0;">Email&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    : {{$data->email}}</p>
                                                <p style="Margin-top: 20px;Margin-bottom: 20px;">&nbsp;</p>
                                            </blockquote>
                                            <p style="Margin-top: 20px;Margin-bottom: 0;">Pengaduan anda sudah ditinjau
                                                dan di konfirmasi,
                                                silahkan cek pada website untuk melihat lebih detail mengenai tanggapan
                                                yang di berikan.</p>
                                            <p style="Margin-top: 20px;Margin-bottom: 0;">&nbsp;</p>
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div style="mso-line-height-rule: exactly;line-height: 60px;font-size: 1px;">
                                            &nbsp;</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="layout one-col fixed-width stack"
                            style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                            <div class="layout__inner"
                                style="border-collapse: collapse;display: table;width: 100%;background-color: #001a1d;">
                                <div class="column"
                                    style="text-align: left;color: #001a1d;font-size: 17px;line-height: 26px;font-family: Raleway,Trebuchet MS,Avenir,Segoe UI,sans-serif;">
                        ...
                        <div class="layout email-footer stack"
                            ...
                            <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
                                <div class="column wide"
                                    style="text-align: left;font-size: 12px;line-height: 19px;color: #fce0cd;font-family: sans-serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);">
                                    <div
                                ...
                                <div class="column narrow"
                                    style="text-align: left;font-size: 12px;line-height: 19px;color: #fce0cd;font-family: sans-serif;Float: left;max-width: 320px;min-width: 200px; width: 320px;width: calc(72200px - 12000%);">
                                    <div
                                        style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
