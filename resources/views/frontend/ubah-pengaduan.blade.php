...
@section('title','Ubah Pengaduan | SMKN 1 Bondowoso')
@section('content')
                    ...
                    <div
                        ...
                        <div class="block mb-4 border border-gray-200 rounded-lg">
                            <input type="text" name="judul_laporan" id="judul_pengaduan"
                                ...
                                value="{{$pengaduan->judul_laporan}}" placeholder="Judul pengaduan">
                        </div>
                        @error('judul_laporan')
                        ...
                        <div class="block  border border-gray-200 rounded-lg">
                            <input type="file" name="berkas_pendukung" accept=".xls,.xlsx,.doc,.docx" id="Nama"
                                class="block w-full px-4 py-3 border-2 border-transparent rounded-lg focus:border-blue-500 focus:outline-none">
                        </div>
                        <div>
                            ...
                            <div class="flex justify-between items-center">
                                <p
                                    class="px-3  my-4 py-1 bg-gray-600 text-gray-100 text-sm font-bold rounded hover:bg-gray-500">
                                    Tidak ada berkas yang dilampirkan</p>
                            </div>
                            @else
                            <div class="mb-4">
                                <a href="{{ asset($pengaduan->berkas_pendukung) }}" class="text-blue-400"
                                    download="{{$pengaduan->berkas_pendukung}}">Download Berkas</i></a>
                            </div>
                            @endif
                        </div>
                        <div class="block">
