...
@section('title', 'Register | Layanan Pengaduan SMKN 2 Karanganyar')
@section('content')
        ...
        <div class="flex flex-col items-center md:flex-row">
            ...
            <div class="w-full mt-10 md:mt-0 md:w-2/5">
                <div
                    ...
                    <h3 class="mb-6 text-2xl font-medium text-center">Daftar Pengaduan <br> <strong>SMKN 2 Karanganyar</strong>
                    </h3>
