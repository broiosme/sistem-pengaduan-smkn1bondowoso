...
<head>
    ...
    <meta name="description"
        content="sistem pengaduan SMKN 1 Bondowoso adalah sistem yang digununakan untuk menyampaikan aspirasi atau pengaduan kepada pihak sekolah secara online">
            ...
            <div class="mx-auto max-w-7xl">
                <nav class="relative z-50 h-24 " x-data="{ showMenu: false }">
                    <div
                        ...
                        <a href="{{url('/')}}" class="w-auto py-4 pr-4 md:py-0">
    <span class="text-xl font-black leading-none text-gray-900 select-none logo">
        <img src="{{asset('assets/index.png')}}" alt="" class="h-16 w-auto">
    </span>
</a>
                        <div class="top-0 left-0 items-start hidden w-full h-full p-4 text-sm bg-gray-900 bg-opacity-50 md:w-3/4 md:absolute lg:text-base md:h-auto md:bg-transparent md:p-0 md:relative md:flex"
                            ...
                            <div
                                ...
                                <a href="{{url('/')}}"
                                    ...
                                    1 Bondow<span class="text-indigo-600">.</span></a>
                                <div
